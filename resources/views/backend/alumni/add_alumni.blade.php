...
<div class="card-body">
<form method="post" action="{{ route('store.alumni') }}" enctype="multipart/form-data">
@csrf
...
<img id="showImage" src="{{ (!empty($all_alumni->photo)) ? url('upload/alumni/'.$all_alumni->photo):url('upload/no_image.jpg') }}" alt="Admin" 
