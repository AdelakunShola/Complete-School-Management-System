...
<img id="showImage" src="{{ asset($librarian->photo) }}" alt="Admin"style="width: 100px; height:100px;" >
</div>
</div>
...
<a href="{{ asset($librarian->certificate) }}" id="showCertificate">Download Certificate</a>
<span id="certificateFileName"><br>File Name: {{ $librarian->certificate ? basename($librarian->certificate) : 'No file selected' }}</span>
</div>
</div>
...
<a href="{{ asset($librarian->nysc_certificate) }}" id="showNyscCertificate" id="downloadLink">Download NYSC Certificate</a>
<span id="nyscCertificateFileName"><br>File Name: {{ $librarian->nysc_certificate ? basename($librarian->nysc_certificate) : 'No file selected' }}</span>
</div>
</div>
...
<a id="showAdditionalDocument" href="{{ asset($librarian->additional_document) }}" id="downloadLink">Download Addition Document</a>
<span id="additionalDocumentFileName"><br>File Name: {{ $librarian->additional_document ? basename($librarian->additional_document) : 'No file selected' }}</span>
</div>
</div>
...
<a id="showAdditionalDocument2" href="{{ asset($librarian->additional_document2) }}" id="downloadLink">Download Addition Document</a>
<span id="additionalDocument2FileName"><br>File Name: {{ $librarian->additional_document2 ? basename($librarian->additional_document2) : 'No file selected' }}</span>
</div>
</div>
