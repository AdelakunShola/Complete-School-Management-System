...
<h3 class="page-title">Edit HRM</h3>
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="students.html">HRM</a></li>
<li class="breadcrumb-item active">Edit HRM</li>
</ul>
</div>
</div>
</div>
...
<div class="card-body">
<form method="post" action="{{ route('update.hrm') }}" enctype="multipart/form-data">
@csrf
<input type="hidden" name="id" value="{{ $hrm->id }}">
<div class="row">
<div class="col-12">
...
<input class="form-control" type="text" name="gender" value="{{ $hrm->gender }}">
</div>
</div>
...
<input class="form-control datetimepicker" type="text" name="dob" value="{{ $hrm->dob }}">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Qualification </label>
<input class="form-control" type="text" name="qualification" value="{{ $hrm->qualification }}">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms ">
<label>Blood Group <span class="login-danger">*</span></label>
<input class="form-control" type="text" name="blood-group" value="{{ $hrm->blood_group }}">
</div>
</div>
...
<input class="form-control " type="text" name="religion" value="{{ $hrm->religion }}">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Phone </label>
<input class="form-control" type="text" name="phone" value="{{ $hrm->phone }}">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Marital Status </label>
<input class="form-control" type="text" name="marital_status" value="{{ $hrm->marital_status }}">
</div>
</div>
...
<input class="form-control" type="text" name="school_attended" value="{{ $hrm->school_attended }}">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms calendar-icon">
<label>Graduation Year</label>
<input class="form-control datetimepicker" type="text" name="graduation_year" value="{{ $hrm->graduation_year }}">
</div>
</div>
...
<input class="form-control" type="text" name="facebook" value="{{ $hrm->facebook }}">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Twitter</label>
<input class="form-control" type="text" name="twitter" value="{{ $hrm->twitter }}">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Linkedin</label>
<input class="form-control" type="text" name="linkedin" value="{{ $hrm->linkedin }}">
</div>
</div>
...
<img id="showImage" src="{{ asset($hrm->photo) }}" alt="Admin"style="width: 100px; height:100px;" >
</div>
</div>
