...
<span class="text-uppercase col-auto  ms-auto download-grp btn btn-outline-primary ">{{ $className }}</span>
...
<script>
    function printSection(sectionName) {
        // Hide all sections except the one to be printed
        $('.section-container').hide();
        $('.section-container:contains("' + sectionName + '")').show();
...
function selectClass(classId) {
  // Make an AJAX request to fetch timetable data for the selected class
  $.ajax({
    url: '/fetch-timetable?class_id=' + classId,
    method: 'GET',
    success: function(response) {
      // Replace the timetable section with the updated timetable data
      $('.timetable-container').html(response);
    },
